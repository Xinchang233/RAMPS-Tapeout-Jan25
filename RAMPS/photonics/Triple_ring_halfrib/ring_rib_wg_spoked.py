...
from ..Single_ring_fullrib.ringheater_halfrib_spoked_middle import RingHeater_middle
...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def get_params_info(cls) -> dict:
        return dict(
            ...
            n_contact_offset='c',
            layer='hjkh',
            si_spoke_offset_percentage='ghjg',
            rmin_in='fhf',
            alpha_zero_in='dfgd',
            angle_coupling='fghf',
            coup_gap_drop='ds',
    ...
    def IJ_addition(self):

        self.add_rect(layer=('IH', 'drawing'),
                      bbox=BBox(right=self.r_core_cent+self.core_width/2+self.r_r_gap+0.12,
                                bottom=-1.5,
                                left=self.r_core_cent+self.core_width/2+self.r_r_gap-0.12,
                                top=1.5,
                                resolution=self.grid.resolution)
                      )
        self.add_rect(layer=('IH', 'drawing'),
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_halfrib/specs/half_rib_triple_ring_spoked.yaml'
