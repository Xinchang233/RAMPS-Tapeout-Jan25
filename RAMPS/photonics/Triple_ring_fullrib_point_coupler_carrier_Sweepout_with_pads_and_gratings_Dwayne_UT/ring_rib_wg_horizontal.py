...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        self.add_rect(layer=('UA', 'drawing'),
                      bbox=BBox(right=2.5*self.gs_pad_pitch+0.5*M6_width,
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_fullrib_point_coupler_carrier_Sweepout_with_pads_and_gratings_Dwayne_UT/specs/full_rib_horizontal_specs.yaml'
    #spec_file = 'Triple_ring_fullrib/specs/full_rib_vertical_specs.yaml'
