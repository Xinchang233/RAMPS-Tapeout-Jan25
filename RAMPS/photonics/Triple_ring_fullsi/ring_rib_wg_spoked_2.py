...
# DROP waveguide routing for gratings   -2-trans_vec_peanut[0], 2*self.r_core_cent+self.ring_bus_gap+ring_pos1[1]+0.2-trans_vec_peanut[1]
        ...
        master_peanut.move_by(dx=trans_vec_peanut[0],
                              dy=(trans_vec_peanut[1] - ring_pos1[1] - self.r_core_cent - self.ring_bus_gap_drop -
                                  self.params['coup_core_width'] / 2), unit_mode=False)
        print("Peanut y transform is {}".format(trans_vec_peanut[1]))
...
#start GSG probe wiring
        ...
        wire1_right = ring_pos1[0] -offset_distance+0.1
        ...
        wire1_bottom = wire1_top - self.gs_bottom_width
        wire1_left = ring_pos2[0]+offset_distance-0.1
...
#Heater wiring start
    #Heater wiring here
        ...
        wire1_bottom = ring_pos1[1]-self.heater_electrode_top_y_span/2
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_fullsi/specs/fullsi_triple_ring_spoked_2.yaml'
