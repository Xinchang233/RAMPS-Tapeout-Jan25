...
from triple_rings_full_si.Ring_new.Adiabatic_ring_cena import adiabatic_ring_tapeout
...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_middle_ring(self):
        ...
        master_peanut.move_by(dx=trans_vec_peanut[0],
                              dy=trans_vec_peanut[1] + ring_pos1[1] + self.r_core_cent + self.ring_bus_gap +
        ...
        wire1_bottom = 1
        wire1_left = -trans_vec_peanut[0] - 10 + 1.6
        ...
        wire1_top = 6 * offset_distance
        wire1_bottom = 1
        wire1_left = trans_vec_peanut[0] + 10 - metal_width - 1.6
        wire1_right = wire1_left + metal_width
        self.add_rect(layer=self.heater_electrode_top_layer,
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
    ...
    def create_in_out_taper(self):
        ...
        taper_params = {'width0': self.in_out_port_width,
                        ...
                        # here this is supposed to be self.coup_slab_width but it is not working , so self.slab_width
