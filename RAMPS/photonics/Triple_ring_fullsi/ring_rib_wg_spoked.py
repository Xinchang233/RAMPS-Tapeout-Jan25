...
from ..Single_ring_fullrib.ringheater_1_fullsi_spoked import RingHeater
...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        #self.draw_concentric_rings2(self.via_info2)
...
# middle ring waveguide and heater gets placed here
...
# waveguide wrapped couipler for gratings   -2-trans_vec_peanut[0], 2*self.r_core_cent+self.ring_bus_gap+ring_pos1[1]+0.2-trans_vec_peanut[1]
        coupler_params = dict(
                layer='si_full_free',
                layer1=('si_full_free', 'drawing'),
                w=peanut_width,
...
#start GSG probe wiring
        ...
        wire1_bottom = wire1_top - self.gs_bottom_width
        wire1_right = 6
        wire1_left = inner_pn_radius+0.3
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
                                left=wire1_left,
...
#Heater wiring start
    #Heater wiring here
        ...
        wire1_top = ring_pos2[1]+self.gs_bottom_width/2-0.5
        wire1_bottom = ring_pos2[1]-self.gs_bottom_width/2-0.5
        wire1_left = -20
        ...
        wire1_bottom = 0.8
        wire1_left = -trans_vec_peanut[0]-4-0.8
        ...
        wire1_top = 20
        wire1_bottom = ring_pos1[1]-self.heater_electrode_top_y_span/2-0.6
        ...
        wire1_top = 6 * offset_distance
        wire1_bottom = 0.8
        wire1_left = trans_vec_peanut[0]+4-metal_width2+0.8
    ...
    def create_in_out_taper(self):
        ...
        taper_params = {'width0': self.in_out_port_width,
                        ...
                        'width_partial': self.slab_width,  #  here this is supposed to be self.coup_slab_width but it is not working , so self.slab_width
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_fullsi/specs/fullsi_triple_ring_spoked.yaml'
