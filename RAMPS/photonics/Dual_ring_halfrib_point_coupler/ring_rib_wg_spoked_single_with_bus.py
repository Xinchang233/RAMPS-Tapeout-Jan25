...
class Single_Ring(BPG.PhotonicTemplateBase):
    """
    ...
    def draw_spoked_rings(self):
        ...
        spoked_ring_master = self.new_template(params=spoke_params, temp_cls=RingRibWg_sr)
        self.add_instance(master=spoked_ring_master, loc=(self.ring_loc[0], self.ring_loc[1]))
        ...
        self.add_pin_primitive(
            ...
            label="RING_STP",
            layer=("M5","label"),
            bbox=BBox(left=self.ring_loc[0]  - 1 * self.r_core_cent + 0.2-0.05,
                      right=self.ring_loc[0]  - 1 * self.r_core_cent + 0.2+0.05,
                      top=0.05,
                      bottom=-0.05,
                      resolution=self.grid.resolution)
            ,
    ...
    def draw_heater(self):
        ...
        if not self.params['heater_disable']:
            ...
            left_heater_loc = (self.ring_loc[0]-self.contact_dist/2.0, -0.3)
            right_heater_loc = (self.ring_loc[0]+self.contact_dist/2.0, -0.3)
            self.add_pin_primitive(
                net_name="RING_HEAT_P",
                label="RING_HEAT_P",
                layer=('UA','label'),
...
#+self.coup_gap+self.r_core_cent+self.params['coup_core_width']/2+self.core_width/2
    ...
    def place_contact_electrodes_basic(self):
        ...
        off_set = (self.r_r_gap/2+self.core_width / 2) + self.r_core_cent
        
        ######################################################################

        # wire1_bottom = 1+ self.modu_centre[1]
        # wire1_top = 2+ self.modu_centre[1]
        # wire1_left = self.modu_centre[0] - (self.r_r_gap / 2) - self.r_core_cent + 2.65+off_set
        # wire1_right = 9
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        ...
        # wire1_top = 1+ self.modu_centre[1]
        # wire1_left = self.modu_centre[0] - (self.r_r_gap / 2) - self.r_core_cent + 3+off_set
        # wire1_right = 9
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        ...
        #                         resolution=self.grid.resolution)
        #               )
        wire1_left = -1+ self.modu_centre[0]
        wire1_right = 0+ self.modu_centre[0]
        wire1_top = self.modu_centre[1] + (self.r_r_gap / 2) + self.r_core_cent - 3-off_set
        wire1_bottom = -9
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
        ...
        wire1_left = 0+ self.modu_centre[0]
        wire1_right = 1+ self.modu_centre[0]
        wire1_top = self.modu_centre[1] + (self.r_r_gap / 2) + self.r_core_cent - 3-off_set
        wire1_bottom = -9
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
        ...
        wire1_left = -2+ self.modu_centre[0]
        wire1_right = -1+ self.modu_centre[0]
        wire1_top = self.modu_centre[1] + (self.r_r_gap / 2) + self.r_core_cent - 2.65-off_set
        wire1_bottom = -9
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
        ...
        wire1_left = 1+ self.modu_centre[0]
        wire1_right = 2+ self.modu_centre[0]
        wire1_top = self.modu_centre[1] + (self.r_r_gap / 2) + self.r_core_cent - 2.65-off_set
        wire1_bottom = -9
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
        ...
        # wire1_top = 1+ self.modu_centre[1]
        # wire1_bottom = -1+ self.modu_centre[1]
        # wire1_left = self.modu_centre[0] - (self.r_r_gap / 2) - self.r_core_cent + 2.5+off_set
        # wire1_right = self.modu_centre[0] - (self.r_r_gap / 2) - self.r_core_cent + 2.8+off_set
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        #                         left=wire1_left,
        ...
        #                         resolution=self.grid.resolution)
        #               )
        # wire1_top = self.modu_centre[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.5-off_set
        # wire1_bottom = self.modu_centre[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.8-off_set
        # wire1_left = -1
        # wire1_right = 1
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        ...
        # wire1_top = 1+ self.modu_centre[1]
        # wire1_bottom = -1+ self.modu_centre[1]
        # wire1_left = self.modu_centre[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.8+off_set
        # wire1_right = self.modu_centre[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.5+off_set
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        #                         left=wire1_left,
        ...
        # wire1_top = 1
        # wire1_bottom = -1
        # wire1_left = self.ring_loc[0] - (self.r_r_gap / 2) - self.r_core_cent + 2.5+off_set
        # wire1_right = self.ring_loc[0] - (self.r_r_gap / 2) - self.r_core_cent + 2.8+off_set
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        #                         left=wire1_left,
        ...
        wire1_right = 1
        wire1_left = -1
        wire1_bottom = self.ring_loc[1] + (self.r_r_gap / 2) + self.r_core_cent - 2.8-off_set
        wire1_top = self.ring_loc[1] + (self.r_r_gap / 2) + self.r_core_cent - 2.5-off_set
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
                                left=wire1_left,
        ...
        # wire1_top = 1
        # wire1_bottom = -1
        # wire1_left = self.ring_loc[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.8+off_set
        # wire1_right = self.ring_loc[0] + (self.r_r_gap / 2) + self.r_core_cent - 2.5+off_set
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        #                         left=wire1_left,
        ...
        # wire1_top = 1
        # wire1_bottom = -1
        # wire1_left = 6.1 / 2+off_set
        # wire1_right = 6.4 / 2+off_set
        # self.add_rect(layer=self.inner_electrode_ring_layers[-1],
        #               bbox=BBox(right=wire1_right,
        #                         bottom=wire1_bottom,
        #                         left=wire1_left,
        ...
        wire1_top = 1
        wire1_bottom = -1
        wire1_left = -6.4 / 2+off_set
        wire1_right = -6.1 / 2+off_set
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
                                left=wire1_left,
        ...
        self.add_pin_primitive(
            ...
            label="RING_GND",
            layer=("BA","label"),
            bbox=BBox(left=-0.05,right=0.05,top=-8.85,bottom=-8.9,resolution=self.grid.resolution),
            show=True
            )
...
if __name__ == '__main__':
    spec_file = 'Dual_ring_halfrib_point_coupler/specs/halfrib_dual_ring_spoked_single.yaml'
