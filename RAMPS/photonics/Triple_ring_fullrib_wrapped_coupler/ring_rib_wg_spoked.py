...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_KG_pieces(self):
        ...
        # ADD kg PIECES
        self.add_rect(layer=('KG', 'drawing'),
                      bbox=BBox(right=-22.5, bottom=6, left=-23.4, top=7.98, resolution=self.grid.resolution))
        self.add_rect(layer=('KG', 'drawing'),
                      bbox=BBox(right=-22.5, bottom=-7.98, left=-23.4, top=-6, resolution=self.grid.resolution))
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_fullrib_wrapped_coupler/specs/full_rib_spoked_specs.yaml'
