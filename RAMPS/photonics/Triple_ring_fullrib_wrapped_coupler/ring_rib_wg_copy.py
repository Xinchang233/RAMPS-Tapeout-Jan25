...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def place_contact_electrodes(self):
        ...
        self.left_pad_loc = (self.ring_loc[0] - (self.gs_pad_pitch ) -(self.r_r_gap+self.core_width )-2*self.r_core_cent,
        ...
        self.right_pad_loc = (self.ring_loc[0] + (self.gs_pad_pitch) +(self.r_r_gap+self.core_width )+2*self.r_core_cent,
                              self.ring_loc[1] - self.gs_pad_to_ring_dist
                              )
...
if __name__ == '__main__':
    spec_file = 'layout/Triple_ring_fullrib/specs/ring_rib_wg_specs.yaml'
