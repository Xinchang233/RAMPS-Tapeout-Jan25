...
class SpokeBase(BPG.PhotonicTemplateBase):
    ...
    def __init__(self, temp_db, lib_name, params, used_names, **kwargs):
        ...
        self.angle0 = self.params['angle0']
        self.angle1 = self.params['angle1']
    ...
    def draw_layout(self):
        delta_theta = (math.pi/180) * (self.angle1-self.angle0) / self.num

        for i in range(self.num):
            theta0 = delta_theta * (i + self.spk_offset)+self.angle0*(math.pi/180)
