...
#         self.add_instance(master=ring, loc=[0, -self.placer / 2], inst_name='ring')
        ...
        # x_spacing = 110
        # add = 56.793 / 2 + 0.2 # spacing for 645 nm results in 375 nm
        # gap = 0.4
        # x_spacing = 110
        # add = 56.793 / 2 + 0.2 # spacing for 585 nm results in 419 nm
        # gap = 0.4
        # x_spacing = 110
        # add = 56.793 / 2 + 0.2  # spacing for 540 nm results in 431 nm
        # gap = 0.4
        x_spacing = 110
        add = 56.793 / 2 + 0.2
        gap = 0.4
        ...
        Wg = AdiabaticRouter(gen_cls=self,
                             ...
                             layer=('rxphot_noopc', 'drawing'),
                             name='init_port11')
        Wg.add_straight_wg(length=135)
        Wg.add_bend_90(size=10)
        Wg.add_straight_wg(length=330, width=0.5)
        # Wg.add_offset_bend(offset=-40, rmin=10)
        ...
        Wg = AdiabaticRouter(gen_cls=self,
                             ...
                             layer=('rxphot_noopc', 'drawing'),
                             name='init_port6')
        Wg.add_straight_wg(length=25)
        Wg.add_bend_90(size=10, turn_left=True)
        Wg.add_straight_wg(length=130, width=0.5)
        Wg.add_bend_90(size=10, turn_left=True)
        Wg.add_straight_wg(length=25 + 130)
        Wg.add_bend_90(size=10, turn_left=False)
        Wg.add_straight_wg(length=230)
        # Wg.add_offset_bend(offset=-40, rmin=10)
