...
class adiabatic_coupler_cena_heater(BPG.PhotonicTemplateBase):
...
#(5+5*math.sin(pi/6)+5.6*math.sin(pi/5), 5.6-(5.6-5.6*math.cos(pi/5)+5-5*math.cos(pi/5)))
    def draw_layout(self) -> None:
        ...
        a = compute_arc_length(Wg.inst[0].master.arc_list)
