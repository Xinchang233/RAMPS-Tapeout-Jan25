...
# changed the origin to modify for dual rf
import BPG
from bag.layout.objects import BBox
from math import ceil


class ViaStack1(BPG.PhotonicTemplateBase):
    """
    ...
    def get_params_info(cls):  # Returns definition of the parameters.
        return dict(
            x_off='asf', # change the origin
            y_off='sd',# change the origin
    ...
    def draw_layout(self):
        ...
        x_off = self.params['x_off']
        y_off = self.params['y_off']
