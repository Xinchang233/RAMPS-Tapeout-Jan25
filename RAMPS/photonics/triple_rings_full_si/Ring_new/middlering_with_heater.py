...
from layout.Ring_new.middlering import RingBase1
...
#         gap = 0.3
#         wg180_radius = 5
        init_port11 = self.add_photonic_port(name='init_port11', center=(-self.params['rout']+self.params['wg_width']/2,  -self.placer/2), orient='R270',
...
#         # (27.6/2,5.6-2.4275919117522138)
        ...
        Wg.add_straight_wg(length=20, width=0.5)
        Wg.add_offset_bend(offset=-165, rmin=20)
        Wg.add_straight_wg(length=20, width=0.5)
        ...
        init_port111 = self.add_photonic_port(name='init_port111', center=(self.params['rout']-self.params['wg_width']/2,  -self.placer/2), orient='R270',
                                             width=self.w, layer=('rxphot_noopc', 'port'))
        #         # init_port = self.add_photonic_port(name='init_port', center=(0,0), orient='R0',width=w, layer=('RX', 'port'))
        #         # (27.6/2,5.6-2.4275919117522138)
        Wg = AdiabaticRouter(gen_cls=self,
