...
class RingHeater1(BPG.PhotonicTemplateBase):
    """
    ...
    def draw_layout(self):
        ...
        left_electrode = electrode_top_rect.transform(loc=(left_heater_loc[0],left_heater_loc[1]), orient='MY', unit_mode=False, copy=True)
        right_electrode = electrode_top_rect.transform(loc=(right_heater_loc[0],right_heater_loc[1]), orient='R0', unit_mode=False, copy=True)
        self.add_label(
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        contact_points = [(-heater_rin, -contact_width / 2.0+self.placer),
                          (-contact_dist / 2.0, -contact_width / 2.0+self.placer),
                          (-contact_dist / 2.0, contact_width / 2.0+self.placer),
                          (-heater_rin, contact_width / 2.0+self.placer)
                          ]
