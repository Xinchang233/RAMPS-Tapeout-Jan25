...
class RingBase1(BPG.PhotonicTemplateBase):
    ...
    def draw_middlering(self) -> None:
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
                      bbox=BBox(left=-(self.access_length / 2 + 4-7),
                                bottom=5.6 - 0.6,
                                right=-self.access_length / 2+7,
                                top=5.6,
                                resolution=self.grid.resolution)
                      )
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
        ...
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
                      bbox=BBox(left=(self.access_length / 2-7),
                                bottom=5.6 - 0.6,
                                right=(self.access_length / 2 + 4-7),
                                top=5.6,
                                resolution=self.grid.resolution)
                      )
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
        ...
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
                      bbox=BBox(left=-(self.access_length / 2 + 1-7),
                                bottom=2,
                                right=-self.access_length / 2+7,
                                top=5.6,
                                resolution=self.grid.resolution)
        ...
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
                      bbox=BBox(left=(self.access_length / 2-7),
                                bottom=2,
                                right=(self.access_length / 2 + 1-7),
                                top=5.6,
                                resolution=self.grid.resolution)
                      )
        self.add_rect(layer=['rxphot_noopc', 'drawing'],
