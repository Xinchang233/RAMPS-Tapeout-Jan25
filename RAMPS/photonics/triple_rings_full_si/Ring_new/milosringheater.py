...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def __init__(self, temp_db, lib_name, params, used_names, **kwargs):
        ...
        self.heater_middle = self.params['heater_middle']
    ...
    def draw_layout(self):
        ...
        self.draw_heater_ring_and_contacts12(
            heater_rout=self.rout,
            ring_width=self.width,
            contact_dist=self.contact_dist,
            contact_width=self.contact_width,
        ...
        viastack_params1 = dict(
            top_layer=('B3', 'drawing'),
            bottom_layer=self.electrode_bottom_lpp,
            top_x_span=self.electrode_top_x_span,
            top_y_span=self.electrode_top_y_span,
            bottom_x_span=self.electrode_bottom_x_span,
        ...
        electrode_master1 = self.new_template(params=viastack_params1, temp_cls=ViaStack)
        left_heater_loc = (-15.5+7, -3)
        self.add_instance(
            master=electrode_master1,
        ...
        left_heater_loc1 = (-self.contact_dist / 2.0, -self.placer/2)
        self.add_instance(
            master=electrode_master,
            inst_name='heater_left_electrode',
            loc=left_heater_loc1,
            orient='MY',
            unit_mode=False,
        )
        left_heater_loc2 = (-self.contact_dist / 2.0, self.placer/2)
        self.add_instance(
            master=electrode_master,
            inst_name='heater_left_electrode',
            loc=left_heater_loc2,
            orient='MY',
            unit_mode=False,
        )
        right_heater_loc = (15.7-7, 3.8)
        self.add_instance(
            master=electrode_master,
        ...
        right_heater_loc1 = (self.contact_dist / 2.0, -self.placer/2)
        self.add_instance(
            master=electrode_master,
            inst_name='heater_right_electrode',
            loc=right_heater_loc1,
            orient='R0',
            unit_mode=False,
        )
        right_heater_loc2 = (self.contact_dist / 2.0, self.placer/2)
        self.add_instance(
            master=electrode_master,
            inst_name='heater_right_electrode',
            loc=right_heater_loc2,
            orient='R0',
            unit_mode=False,
        )
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        contact_points = [(-heater_rin, -contact_width / 2.0-self.placer/2),
                          (-contact_dist / 2.0, -contact_width / 2.0-self.placer/2),
                          (-contact_dist / 2.0, contact_width / 2.0-self.placer/2),
                          (-heater_rin, contact_width / 2.0-self.placer/2)
                          ]
    ...
    def draw_heater_ring_and_contacts12(self,
                                      heater_rout: "dim_type",
                                      ring_width: "dim_type",
                                      contact_dist: "dim_type",
                                      contact_width: "dim_type",
