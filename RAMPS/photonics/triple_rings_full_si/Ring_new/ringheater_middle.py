...
class RingHeater_middle(BPG.PhotonicTemplateBase):
    """
    ...
    def draw_heater_ring_and_contacts12(self,
        ...
        # Create the left side contact
        contact_points = [(-self.heater_middle, -contact_width / 2.0 ),
                          (-contact_dist / 2.0, -contact_width / 2.0 ),
                          (-contact_dist / 2.0, contact_width / 2.0 ),
                          (-self.heater_middle, contact_width / 2.0 )
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=('sldphot','drawing'),
