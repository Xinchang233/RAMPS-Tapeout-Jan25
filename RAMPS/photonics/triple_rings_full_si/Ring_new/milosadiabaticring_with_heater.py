...
from layout.Ring_new.milosringheater import RingHeater
import importlib
from layout.Ring_new.ringheater_middle import RingHeater_middle
from layout.Ring_new.ringheater1 import RingHeater1
from layout.Ring_new.milosadiabaticringonly import RingBase1
...
from layout.Ring_new.milosTest_Adiabatic_router import adiabatic_ring
from layout.Ring_new.GS_pads import GSPads
from layout.Ring_new.milosGS_pads1 import GSPads1
...
#         # (27.6/2,5.6-2.4275919117522138)
        ...
        ring = self.new_template(params={'layer': ('rxphot_noopc', 'drawing'),
                                         ...
                                         'theta1': 90},
                                 temp_cls=SimpleRound)
        self.add_instance(master=ring, loc=[19-7, 0], inst_name='ring')
