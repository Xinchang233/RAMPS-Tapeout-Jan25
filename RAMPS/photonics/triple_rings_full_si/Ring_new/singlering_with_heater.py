...
from layout.Ring_new.GS_pads1_singlering import GSPads1
...
class RingWithHeaterBase(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        middle_ring_params = dict(
            ...
            w=self.params['w'],
            x=self.params['x'],
            y=self.params['y']-self.params['placer']/2,
            gap=self.params['gap'],
