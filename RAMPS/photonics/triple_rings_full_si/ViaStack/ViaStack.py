...
class ViaStack(BPG.PhotonicTemplateBase):
    ...
    def __init__(self, temp_db, lib_name, params, used_names, **kwargs):
        ...
        self.side_align = None
        self.use_top_bbox = None

    @classmethod
    def get_default_param_values(cls):
        return dict(
            side_align=False,  # Center align all layers
    ...
    def get_params_info(cls):  # Returns definition of the parameters.
        return dict(
            ...
            side_align='True to side-align all layers and vias (so all layer shapes share the same -x coordinate).'
    ...
    def draw_layout(self):
        ...
        self.side_align = self.params['side_align']
        self.use_top_bbox = False #self.params['use_top_bbox']
