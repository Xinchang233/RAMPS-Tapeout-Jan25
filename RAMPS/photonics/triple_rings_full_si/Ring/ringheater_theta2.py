...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        left_heater_loc = (-self.contact_dist - 1.5, self.contact_width/2 - 1.0)#(-self.contact_dist/2.0, 0)
        ...
        right_heater_loc = (self.contact_dist + 1.5, self.contact_width/2 - 1.0)
        ...
        if disk_layers:
            for layer in disk_layers:
                ...
                contact_points = [(heater_rout + self.disk_layer_extension, -  self.disk_layer_extension),
                                  ...
                                  (-heater_rout - self.disk_layer_extension, contact_width + self.disk_layer_extension),
                                  (heater_rout + self.disk_layer_extension, contact_width + self.disk_layer_extension)
                                  ]
