...
from Photonic_Core_Layout_Djordje.Ring.ringheater import RingHeater
...
class RingBase(BPG.PhotonicTemplateBase):
    ...
    def place_heater_ring(self):
        ...
        heater_disk_layers = [('nnphot', 'drawing'), ('sldphot', 'drawing')]

        heater_electrode_top_layer = ('B3', 'drawing')
        ...
        if heater_electrode_bottom_y_span is None:
            ...
            self.add_instance(master=heater_master, orient='R90')
