...
class GcBidirWl1300nmMfd9200nmCurved(BPG.PhotonicTemplateBase):
    ...
    def get_default_param_values(cls):
        return dict(
            gds_path='layout/Importers/Gratings/Manuj/bidirectional/gds/GDS_grating_couplers/gc_diruni_unif_lam1300_mfd5000_15degup_air_201210125816_dataprep_calibre.gds'
        )
