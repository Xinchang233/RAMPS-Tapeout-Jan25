...
class GcUnidirWl1300nmMfd5000nmApodDown_fromAL11A(BPG.PhotonicTemplateBase):
    """
    ...
    def get_default_param_values(cls):
        return dict(
            gds_path='layout/Importers/Gratings/higheff1300lm5um/gds/gc_diruni_apod_lam1300_mfd5000_neg15down_air_al11a_dataprep_calibre.gds'
        )
