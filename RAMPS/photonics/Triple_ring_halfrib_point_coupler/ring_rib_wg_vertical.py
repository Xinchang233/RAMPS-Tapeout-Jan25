...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_input_wg(self):
        ...
        if self.bent_coupler:
            ...
            self.r_r_gap + 3*self.core_width/2) - self.coup_core_width / 2 - self.coup_gap - 3 * self.r_core_cent,
...
if __name__ == '__main__':
    spec_file = 'Triple_ring_halfrib_point_coupler/specs/half_rib_triple_ring_vertical.yaml'
