...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_Spokes(self, doping_spoke_info):
        ...
        self.draw_contact_spokes_and_via_stack_p(
            r_via=p_via_radius - 0.05,
        ...
        self.draw_electrode_ring_and_spokes_p(
            ring_layer_indices=[1, 2, 3, 4],
            spoke_layer_indices=[],
            electrode_rout=electrode_rout_p - 0.6,
            electrode_rin=electrode_rin_p - 0.6,
        ...
        self.draw_electrode_ring_and_spokes_p(
            ...
            electrode_rin=electrode_rin_n + 0.25,
            via_radius=n_via_radius - 0.15,
            spoke_num=self.spoke_num,
            offset=self.n_contact_offset,
        )
    ...
    def draw_input_wg(self):
        ...
        y_coord=-(trans_vec_peanut[1]+ ring_bus_gap+self.r_core_cent+self.params['coup_core_width']/2)
    ...
    def place_contact_electrodes_basic(self):
        ...
        wire1_bottom = wire1_top - self.gs_bottom_width
        wire1_left = -8
        wire1_right = -offset_distance+0.8
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire1_right,
                                bottom=wire1_bottom,
                                left=wire1_left,
        ...
        # draw right pad wiring
        wire1_top = -(offset_distance+0.2)+1.9
        wire1_bottom = -8
        wire1_left = -self.gs_bottom_width/2
    ...
    def place_heater_contact_electrodes_basic(self):
        ...
        wire1_top = 10
        wire1_bottom = -self.heater_electrode_top_y_span / 2-0.45
    ...
    def draw_electrode_ring_and_spokes_p(self,
        ...
        for layer_ind in spoke_layer_indices:
            ...
            spoke_master = self.new_template(params=spoke_info, temp_cls=SpokeBase)
            #self.add_instance(master=spoke_master,inst_name='electrode_spokes',loc=self.ring_loc,orient="R0",unit_mode=False,)
    ...
    def draw_contact_spokes_and_via_stack_p(self,
                                          r_via: float,
                                          spoke_num: int,
                                          offset: float,
                                          bot_layer: "layer_or_lpp_type",
