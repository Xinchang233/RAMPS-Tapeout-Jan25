...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_input_wg_slab(self):
        ...
        coupler_params = dict(
            ...
            wg180_radius=10,
            r_core_cent=self.params['r_core_cent'],
            coup_core_width=self.params['slab_width'],
            rmin_in=self.params['rmin_in'],
            alpha_zero_in=self.params['alpha_zero_in'],
            angle_coupling=self.params['angle_coupling'],
        )
        ...
        trans_vec_peanut = - peanut_top_port.center
        master_peanut.move_by(dx=trans_vec_peanut[0],
                              dy=trans_vec_peanut[1] + ring_bus_gap+self.r_core_cent+self.params['coup_core_width']/2+10 ,
                              unit_mode=False)
        x_coord=trans_vec_peanut[0]
        y_coord=-(trans_vec_peanut[1]+ ring_bus_gap+self.r_core_cent+self.params['coup_core_width']/2)
        print("Peanut x transform(for lumerical) is {}".format(x_coord))
...
if __name__ == '__main__':
    ...
    spec_file = 'Single_ring_fullsi/specs/fulsi_single_ring_wrapped.yaml'
