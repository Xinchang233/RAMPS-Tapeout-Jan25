...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def get_params_info(cls) -> dict:
        return dict(
            ...
            n_contact_offset='c',
            layer='hjkh',
            si_spoke_offset_percentage='adas',
            rmin_in='fhf',
            alpha_zero_in='dfgd',
            angle_coupling='fghf',
    ...
    def draw_Spokes(self, doping_spoke_info):
        ...
        if p_via_radius < n_via_radius:
            ...
            n_electrode_layer_ind_list = self.outer_electrode_ring_layer_inds #inds
            ...
            p_electrode_layer_ind_list = self.outer_electrode_ring_layer_inds  #self.outer_electrode_ring_layer_inds
        ...
        print(self.outer_electrode_ring_layer_inds)
        print(self.inner_electrode_ring_layer_inds)
        ...
        self.draw_electrode_ring_and_spokes_p(
            ring_layer_indices=[2,3,4],
            spoke_layer_indices=[],
            electrode_rout=electrode_rout_p-0.55,
            electrode_rin=electrode_rin_p-0.55,
        ...
        self.draw_electrode_ring_and_spokes(
            ring_layer_indices=[1,2,3,4,5],
            spoke_layer_indices=[1],
            electrode_rout=electrode_rout_n-0.2,
            electrode_rin=electrode_rin_n-0.2,
            via_radius=n_via_radius,
            spoke_num=self.spoke_num,
            offset=self.n_contact_offset,
        )
        print(n_electrode_layer_ind_list)
    ...
    def place_contact_electrodes_basic(self):
        ...
        wire1_left = -8
        wire1_right = -offset_distance+0.6
        ...
        wire1_top = -(offset_distance - 2)-0.3
        wire1_bottom = -8
    ...
    def place_heater_contact_electrodes_basic(self):
        ...
        wire1_top = 10
        wire1_bottom = -self.heater_electrode_top_y_span / 2-0.35
    ...
    def draw_electrode_ring_and_spokes(self,
        ...
        for layer_ind in spoke_layer_indices:
            ...
            print('a')
            print(self.grid.tech_info.get_layer_name(layer_ind))
    ...
    def draw_electrode_ring_and_spokes_p(self,
                                       ring_layer_indices: Union[int, List[int]],
                                       spoke_layer_indices: Union[int, List[int]],
                                       electrode_rout: float,
                                       electrode_rin: float,
...
if __name__ == '__main__':
    ...
    spec_file = 'Single_ring_fullsi/specs/fullsi_single_ring_vertical.yaml'
