...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def get_params_info(cls) -> dict:
        return dict(
            ...
            n_contact_offset='c',
            layer='hjkh',
            si_spoke_offset_percentage='ghg',
            rmin_in='fhf',
            alpha_zero_in='dfgd',
            angle_coupling='fghf',
            coup_gap_drop='dsfs',
    ...
    def place_contact_electrodes_basic(self):
        ...
        wire1_left = -10
        wire1_right = -offset_distance+0.1
...
if __name__ == '__main__':
    spec_file = 'Single_ring_halfrib_point_coupler/specs/half_rib_single_ring_spoked.yaml'
