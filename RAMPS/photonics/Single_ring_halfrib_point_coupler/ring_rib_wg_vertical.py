...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def place_contact_electrodes_basic(self):
        ...
        wire1_left = -10
        wire1_right = -offset_distance+0.2
        ...
        width = 2
        offset_distance = inner_pn_radius
        # draw right pad wiring
        wire1_top = self.ring_loc[1]
        wire1_bottom = wire1_top - self.gs_bottom_width
        wire1_left = offset_distance
        wire1_right = 10
    ...
    def draw_input_wg(self):
        ...
        if self.bent_coupler:
            ...
            loc = (self.ring_loc[0] - max(core_master.arc_list[3]['y']) - (
            self.core_width/2) - self.coup_core_width / 2 - self.coup_gap - self.r_core_cent,
    ...
    def draw_Spokes(self, doping_spoke_info):
        ...
        self.draw_electrode_ring_and_spokes(
            ...
            electrode_rout=electrode_rout_p+0.1+0.5,
            electrode_rin=electrode_rin_p+0.1,
        ...
        self.draw_electrode_ring_and_spokes(
            ...
            spoke_layer_indices=[5],
            electrode_rout=electrode_rout_n-0.1,
            electrode_rin=electrode_rin_n-0.1-0.5,
    ...
    def place_contact_electrodes(self):
        ...
        wire2_left = self.right_pad_loc[0] - width / 2
        wire2_right = self.right_pad_loc[0] + width / 2
        self.add_rect(layer=self.inner_electrode_ring_layers[-1],
                      bbox=BBox(right=wire2_right,
                                bottom=wire2_bottom,
                                left=wire2_left,
...
if __name__ == '__main__':
    spec_file = 'Single_ring_halfrib_point_coupler/specs/half_rib_single_ring_vertical.yaml'
