...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rin+0.15),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.25, -heater_rin + 0.35),
                          (-contact_dist / 2.0, -heater_rin + 0.35),
                          (-contact_dist / 2.0, -heater_rin + 0.45),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.25,-heater_rin + 0.45)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
