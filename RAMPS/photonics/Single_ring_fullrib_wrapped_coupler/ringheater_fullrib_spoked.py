...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.6, -heater_rin + 0.65),
                          (-contact_dist / 2.0, -heater_rin + 0.65),
                          (-contact_dist / 2.0, -heater_rin + 0.95),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.6,-heater_rin + 0.95)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
