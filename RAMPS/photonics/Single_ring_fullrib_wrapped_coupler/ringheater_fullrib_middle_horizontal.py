...
class RingHeater_middle(BPG.PhotonicTemplateBase):
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rout+0.28),
                         (-contact_dist / 2.0, -heater_rout+0.28),
                         (-contact_dist / 2.0, contact_width / 2.0),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7, -heater_rin + 0.45),
                          (-contact_dist / 2.0, -heater_rin + 0.45),
                          (-contact_dist / 2.0, -heater_rin + 0.65),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7,-heater_rin + 0.65)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
