...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rin+0.36),
                         (-contact_dist / 2.0, -heater_rin+0.36),
                         (-contact_dist / 2.0, contact_width / 2.0),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.4, -heater_rin + 0.55),
                          (-contact_dist / 2.0, -heater_rin + 0.55),
                          (-contact_dist / 2.0, -heater_rin + 1.05),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.4,-heater_rin + 1.05)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
