...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        left_heater_loc = (-self.contact_dist/2.0, -0.55)
        self.add_instance(
        ...
        right_heater_loc = (self.contact_dist / 2.0, -0.55)
        self.add_instance(
            master=electrode_master,
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rout+0.5),
                         (-contact_dist / 2.0, -heater_rout+0.5),
                         (-contact_dist / 2.0, contact_width / 2.0),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7, -heater_rin + 0),
                          (-contact_dist / 2.0, -heater_rin + 0),
                          (-contact_dist / 2.0, -heater_rin + 1.1),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7,-heater_rin + 1.1)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
