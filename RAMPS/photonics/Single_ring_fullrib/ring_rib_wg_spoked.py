...
from ..Single_ring_fullrib.ringheater_fullrib_spoked import RingHeater
...
class RingRibWg(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        self.draw_doping_spokes(self.doping_spoke_info)
        self.draw_heater()
    ...
    def draw_KG_pieces(self):
        ...
        self.add_rect(layer=('KG', 'drawing'),
                      bbox=BBox(right=-2.795, bottom=9.66, left=-3.395, top=9.69, resolution=self.grid.resolution))
        self.add_rect(layer=('KG', 'drawing'),
                      bbox=BBox(right=-2.795, bottom=-9.69, left=-3.395, top=-9.66, resolution=self.grid.resolution))
    ...
    def place_contact_electrodes(self):
        ...
        wire1_top = -(self.r_core_cent+self.inner_electrode_info[-1]['dist0'])
...
if __name__ == '__main__':
    ...
    spec_file = 'Single_ring_fullrib/specs/full_rib_spoked_specs.yaml'
