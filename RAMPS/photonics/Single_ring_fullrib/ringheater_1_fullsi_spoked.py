...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_layout(self):
        ...
        left_heater_loc = (-self.contact_dist/2.0, -0.45)
        self.add_instance(
        ...
        right_heater_loc = (self.contact_dist / 2.0, -0.45)
        self.add_instance(
            master=electrode_master,
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rin+0.05-0.75),
                         (-contact_dist / 2.0, -heater_rin+0.05-0.75),
                         (-contact_dist / 2.0, contact_width / 2.0),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.25, -heater_rin + 0.25),
                          (-contact_dist / 2.0, -heater_rin + 0.25),
                          (-contact_dist / 2.0, -heater_rin + 0.37),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.25,-heater_rin + 0.37)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
