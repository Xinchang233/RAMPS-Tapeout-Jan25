...
class RingHeater(BPG.PhotonicTemplateBase):
    ...
    def draw_heater_ring_and_contacts(self,
        ...
        #                  ]
        contact_points = [(-contact_dist / 2.0-self.electrode_bottom_x_span, -heater_rout+0.45),
                         (-contact_dist / 2.0, -heater_rout+0.45),
                         (-contact_dist / 2.0, contact_width / 2.0),
        ...
        contact_points = [(-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7, -heater_rin + 0.55),
                          (-contact_dist / 2.0, -heater_rin + 0.55),
                          (-contact_dist / 2.0, -heater_rin + 0.85),
                          (-contact_dist / 2.0 - self.electrode_bottom_x_span-0.7,-heater_rin + 0.85)
                          ]
        polygon = PhotonicPolygon(
            resolution=self.grid.resolution,
            layer=device_layer,
