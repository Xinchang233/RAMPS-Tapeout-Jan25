...
from layout.Pumpfilter.old.Pumpfilter import Pumpfilter
from layout.RingSensable.RingSensable import RingSensableWithCosine
...
class sourceandfilters(BPG.PhotonicTemplateBase):
    ...
    def create_source(self) -> None:
        self.filters_master['source'] = self.new_template(params=self.source_params,
                                                          temp_cls=RingSensableWithCosine)
