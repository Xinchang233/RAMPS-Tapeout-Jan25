...
class Gc_diruni_apod_wl1300_mfd9200_deg15_cladair_longtaper(BPG.PhotonicTemplateBase):
    """
    ...
    def get_default_param_values(cls):
        return dict(
            gds_path='layout/GratingCoupler/gds/gc_diruni_apod_wl1300_mfd9200_deg15_cladair_longtaper_dataprep_calibre.gds'
        )
