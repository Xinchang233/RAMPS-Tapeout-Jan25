...
class GcUnidirBackWl1550nmMfd5000nmUp(BPG.PhotonicTemplateBase):
    """
    ...
    def get_default_param_values(cls):
        return dict(
            gds_path='layout/Importers/GDS_grating_couplers/gc_TE_1550_degneg15_mfd5um_unidir_apod_up_curved_dataprep_calibre.gds'
        )
